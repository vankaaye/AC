...
- [x] **DONE (13 Jul):** FormSubmit form activated — enquiries now deliver to gopi@ktechify.com.
...
| 13 Jul 2026 | **/hero-videos reorganised into two clear groups + resolution badges** — after the owner asked to see 1080p/QHD carer footage, regrouped the page: **"🤝 A support worker helping"** section leads with every white-cast carer clip regardless of resolution (V1 montage & V2/V3 yellow-uniform 7475 shoot at 1080p; V16 health-check, V17 companion visit, V24 meal, V30 friendly visit at 4K; Mixkit V5/6/7/9/10 white-carer at 720p), each stamped with a colour-coded 4K/1080p/720p badge. Second section "☀️ Living well at home — 4K" holds the happy-client lifestyle clips. Dropped the non-white carer clip (old V26) and the rehab/exercise clips from display. Honest footnote on the carer-footage/resolution tradeoff retained. | (this commit) |
| 13 Jul 2026 | **Carer clips: deep search, honest limit** (owner: rehab/wheelchair read as "disabled services"; then "search deep and come up with something close") — removed all rehab/wheelchair/bed clips. Found the elegant white-cast 4K Kampus home shoot (7231xxx): V17 now a companion/social-support visit (younger woman visiting an older woman for a chat). Four white-cast 4K care clips remain — health check at home (V16), companion visit (V17), serving a meal (V24), friendly visit (V30). CONCLUSION LOGGED: true 4K of a *uniformed carer actively assisting a white senior at home* does not exist on free stock; the perfect-brief 7475 shoot (yellow-uniform carer + elderly couple) is 1080p and already used in the hero/cards. For more/true-4K carer footage → paid stock (~$50-100/clip) or a real half-day shoot. | (this commit) |
| 13 Jul 2026 | **Carer clips recast to white** (owner: carer clips should be white cast, matching site direction) — the 7522xxx/7517xxx carer clips featured a non-white cast; replaced the 5 with white-cast 4K care clips: guided arm exercises (V16), a wheelchair walk (V17), a strengthening exercise (V19), an at-home blood-pressure check with a white couple (V20), a rehab mobility session (V23). V24 meal-serve and V30 friendly-visit kept. | (this commit) |
| 13 Jul 2026 | **Carer-helping 4K clips added** (owner: "the 4K videos don't show a care worker helping") — swapped 7 solo-portrait slots on `/hero-videos` for native-4K clips that clearly show a support worker actively helping: steadying a client up from a chair (V16), two workers helping a client walk (V17), guided arm-stretch exercises (V19), a reassuring hand on the sofa (V20), comfort and support (V23), serving a home-cooked meal (V24), a friendly visit and chat (V30). Each tagged "🤝 Care in action"; happy-client lifestyle clips kept for balance. | (this commit) |
| 13 Jul 2026 | **20 true-4K hero candidates** — added a "✨ True 4K collection" section to `/hero-videos` (V13–V32), every clip from a native 3840×2160 or 4096×2160 Pexels source: warm portraits, garden/greenhouse, park walks, coffee catch-ups, gentle group exercise and in-home care. Vetted from ~30 candidates via SD contact sheets (dropped camera-stares, hugs, kids and care-bed scenes per prior owner rules). Page now offers 30 options total; quality note updated (4K now available, only real-team faces need a shoot). | (this commit) |
| 13 Jul 2026 | **Our story + Melbourne service area** — new "Why we started Astro Care" section (honest founder story, no invented names, flowers-visit video alongside, CTAs to contact/fees); service area "all of Melbourne" woven through hero subline, statement, a new first FAQ ("Where does Astro Care operate?"), footer blurb, meta description and LocalBusiness JSON-LD (areaServed: Melbourne). FormSubmit activation confirmed done by owner — enquiry emails now flowing. | (this commit) |
| 13 Jul 2026 | **First-party analytics** — Cloudflare Web Analytics API was out of the token's scope, so built better: a no-cookie page-view beacon on every page + daily counters in Workers KV, with an owner dashboard at the worker's `/stats` URL showing 14 days of page views, chats and enquiries side by side (a real funnel view). Live-tested: beacon 204, counter incremented, chat unaffected. | (this commit) |
| 13 Jul 2026 | **One-hour foundation batch** — `/privacy` policy page (linked in footer + beside the form); FAQ section "The things families ask us first" (7 accordions) with FAQPage structured data; SEO pack: OG/social tags, canonical URLs, LocalBusiness JSON-LD, `sitemap.xml`, `robots.txt` (studio/test pages disallowed + noindexed); custom 404 page; chat worker now rate-limits ~30 chats/hour/IP with a friendly hand-off to the callback form (cost guard, redeployed + live-tested). Still owner-only: provider-claim wording, GoDaddy email forwarding, FormSubmit activation, key rotation, phone number check. | `cdf0fe4` |
| 13 Jul 2026 | **Provider badge relocated** — "Australian owned & run · My Aged Care approved provider" pill removed from the top of the hero (cleaner headline entry) and placed in the footer under the company blurb, with an amber shield. | (this commit) |
| 13 Jul 2026 | **Step-1 refresh + hero service chips** — "Say hello" video replaced (the consult clip was also in the hero montage and a divider): now a warm 4K-sourced scene of a silver-haired woman happily on the phone (Pexels 6786346), which matches the step's "chat or leave your number" message; hero gains a quiet row of five glass chips with amber ticks — Nursing & clinical care · Personal care · Cleaning & home help · Meals · Social support — each linking to Services, so what we offer is clear at first glance without being flashy. | (this commit) |
| 13 Jul 2026 | **Owner punch list #3** — footer "Talk to us"/"Explore" headings now amber (the global h3 colour rule was silently overriding the white utility class); accessibility panel gains an ✕ close button and text can now shrink below default (new 85% step, so A− works from 100%); contact chat button renamed "Astro Chat — instant answers" and made compact (no "AI" wording); Commission tile now shows the Australian Government crest matching its real site branding; new **"Prefer to watch?" video section** — four official YouTube explainers embedded (My Aged Care assessment, preparing for assessment, Support at Home contributions, Commission's "A new era of aged care"), all verified embeddable, privacy-friendly youtube-nocookie + lazy loading. | (this commit) |
